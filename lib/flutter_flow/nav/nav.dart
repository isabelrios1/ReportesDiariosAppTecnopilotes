...
GoRouter createRouter(AppStateNotifier appStateNotifier) {
  ...
  return GoRouter(
    ...
    routes: [
      ...
      FFRoute(
        name: NuevoRegistroDiarioWidget.routeName,
        path: NuevoRegistroDiarioWidget.routePath,
        builder: (context, params) => NuevoRegistroDiarioWidget(),
      ),
      FFRoute(
        name: HorasYKilometrajesWidget.routeName,
        path: HorasYKilometrajesWidget.routePath,
        builder: (context, params) => HorasYKilometrajesWidget(),
      ),
      FFRoute(
      ...
      FFRoute(
        name: ParadaDeMaquinariaWidget.routeName,
        path: ParadaDeMaquinariaWidget.routePath,
        builder: (context, params) => ParadaDeMaquinariaWidget(),
      ),
      FFRoute(
        name: RegistroCombustibleWidget.routeName,
        path: RegistroCombustibleWidget.routePath,
        builder: (context, params) => RegistroCombustibleWidget(),
      ),
      FFRoute(
        name: RegistroMantenimientoWidget.routeName,
        path: RegistroMantenimientoWidget.routePath,
        builder: (context, params) => RegistroMantenimientoWidget(),
      ),
      FFRoute(

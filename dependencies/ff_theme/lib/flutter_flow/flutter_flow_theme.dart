...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF293A5A);
  late Color secondary = const Color(0xFFE5E0D5);
  late Color tertiary = const Color(0xFFECECEC);
  late Color alternate = const Color(0xFFE3521F);
  late Color primaryText = const Color(0xFF293A5A);
  late Color secondaryText = const Color(0xFF556684);
  late Color primaryBackground = const Color(0xFFE5E0D5);
  late Color secondaryBackground = const Color(0xFFECECEC);
  late Color accent1 = const Color(0xFFE3521F);
  late Color accent2 = const Color(0xFFFFFFFF);
  late Color accent3 = const Color(0xFF293A5A);
  late Color accent4 = const Color(0xFFECECEC);
